...
def director_dao():
    ...
    director_1 = Director(id=1, name="Sergei Eisenstein")
    director_2 = Director(id=2, name="Federico Fellini")
    director_3 = Director(id=3, name="Emir Kusturica")
...
class TestService:
    ...
    def test_create_director(self):
        create_director = {"id": 2, "name": "Federico Fellini"}
    ...
    def test_update(self):
        director_update = {"id":1, "name":"Sergei Michailovich Eisenstein"}
